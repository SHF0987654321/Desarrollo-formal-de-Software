...
import { ArrowLeft, Eye, EyeOff, X, Building2 } from "lucide-react"
...
export default function BusinessLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Business login successful:", formData)
  }
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-800 mb-2">Acceso Empresarial</h1>
            <p className="text-slate-600">Inicia sesión en tu cuenta corporativa</p>
          </div>
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white shadow-lg hover:shadow-xl transition-all duration-300 py-3"
                >
                  {isLoading ? (
              ...
              <div className="text-center">
                <p className="text-sm text-slate-600">
                  ...
                  <Link
                    href="/tipo-registro/registro-empresarial"
              ...
              <div className="text-center pt-4 border-t border-slate-100">
                ...
                <div className="flex justify-center space-x-4 text-xs">
                  <Link href="/business-support" className="text-emerald-600 hover:text-emerald-700 underline">
                    Soporte Empresarial
                  </Link>
                  <Link href="/contact-sales" className="text-emerald-600 hover:text-emerald-700 underline">
                    Contactar Ventas
                  </Link>
                </div>
              </div>
          ...
          <div className="mt-6 text-center">
            <div className="bg-slate-100 rounded-lg p-4">
              <p className="text-xs text-slate-600 leading-relaxed">
                <strong>Nota de Seguridad:</strong> Tu conexión está protegida con encriptación SSL. OHO nunca
                compartirá tus credenciales empresariales con terceros.
              </p>
            </div>
          </div>
        </div>
